...
$sth11=$dbh->prepare("CREATE TABLE author(authid int(6) auto_increment, type varchar(5), authorname varchar(400), primary key(authid))auto_increment=10001 ENGINE=MyISAM;");
$sth11->execute();
$sth11->finish(); 
