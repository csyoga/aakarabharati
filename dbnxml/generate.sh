...
echo "DROP TABLE IF EXISTS books; CREATE TABLE books(bookid varchar(5), sstitle varchar(500),level varchar(10), page varchar(30), title varchar(1000),  authorname varchar(1000)) ENGINE=MyISAM character set utf8 collate utf8_general_ci" | /usr/bin/mysql -u$usr -p$pwd $db
