...
$query = 'select * from author where authorname like \'' . $letter . '%\' and type=06 order by authorname';
...
{
	echo '<span class="sml">Sorry! No author names were found to begin with the letter \'' . $letter . '\' in Rangabhumi</span>';
}
