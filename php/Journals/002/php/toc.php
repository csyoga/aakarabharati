...
$query = 'select * from article_samvada where part=\'' . $part . '\'';
...
if($num_rows > 0)
{
	while($row = $result->fetch_assoc())
	{
		...
		echo '	<span class="aTitle"><a target="_blank" href="../Volumes/samvada'  . $row['part'] . '/index.djvu?djvuopts&amp;page=' . $row['page'] . '.djvu&amp;zoom=page">' . $row['title'] . '</a></span><br />';
		if($row['authid'] != 0) {
