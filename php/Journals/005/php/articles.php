...
$query = 'select * from article_ab where title like \'' . $letter . '%\' order by title, part, page_start';
...
{
	echo '<span class="sml">Sorry! No articles were found to begin with the letter \'' . $letter . '\' in arivubaraha</span>';
}
