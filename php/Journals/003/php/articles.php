...
$query = 'select * from article_maatukate where title like \'' . $letter . '%\' order by volume, part, title, page_start';
...
{
	echo '<span class="sml">Sorry! No articles were found to begin with the letter \'' . $letter . '\' in maatukate</span>';
}
