				...
				<ul class="cd-secondary-nav is-hidden">
					...
					<li class="has-children">
						...
						<ul class="is-hidden">
							...
							<li><a href="index.php">ಮಾತುಕತೆ</a></li>
	...
	<main class="cd-main-content">
		...
		<div id="sec_nav">
					<ul class="actions">
						...
						<li><a href="../../volumes.php?journalid=003" class="button button-outline">ಸಂಪುಟ</a></li>
						<li><a href="../../articles.php?journalid=003" class="button button-outline">ಲೇಖನ</a></li>
						<li><a href="../../authors.php?journalid=003" class="button button-outline">ಲೇಖಕ</a></li>
						<li><a href="../../search.php?journalid=003" class="button button-outline">ಹುಡುಕು</a></li>
					</ul>
		</div>
	</div>
